...
NodeBase = namedtuple('Node', ['est_total', 'cost', 'pos', 'prev_delta', 'histo'])

class Node(NodeBase):

    def __hash__(self):
        return (self.pos, self.prev_delta).__hash__()

    def __eq__(self, other):
        return (self.pos, self.prev_delta) == (other.pos, other.prev_delta)
